        ...
        <div className='flow-root p-12 h-full flex'>
            ...
            <div className='flex flex-col float-left justify-center w-[60%] p-12'>
                ...
                <label className='mx-2 font-bold'>Email</label>
                 <input onChange={handleChange} name="email" value={formData.email} type='text' className='bg-slate-200 p-0 border text-black rounded-lg max-h-[10%] mx-2 mb-2 max-w-[70%] border-black'/>
                 <label className='mx-2 font-bold'>Password</label>
                 <input onChange={handleChange} name='password' value={formData.password} type='text' className='bg-slate-200 p-0 border text-black rounded-lg max-h-[10%] mx-2 mb-2 max-w-[70%] border-black' />  
            ...
            <div class="flex flow-root items-center mb-4 max-w-[70%]">
                <input onChange={handleChange} name='checked' id="default-checkbox" type="checkbox" value={formData.checked} class="items-center float-left justify-start ml-2 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                ...
                <button type='submit' onSubmit={handleSubmit} className='items-center float-right justify-end align-right bg-[#028090] rounded-lg text-white px-4 py-2 flex flex-wrap'><a>Sign In &nbsp;</a><FaAngleRight /></button>
